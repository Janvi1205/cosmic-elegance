...
const ContactPage = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.fromTo(".contact-form-section", { y: 40, opacity: 0 }, {
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-background">
      <SEOHead
        title="Contact & Book Consultation — Astrologer Sanjeev Sharmaji"
        description="Book a personalized Vedic astrology consultation with Astrologer Sanjeev Sharmaji. Contact via phone (+91 99881 74274), email, or visit chambers in Sector 18-C Chandigarh & Bathinda."
      ...
      <section className="section-padding bg-background pt-32">
        <div className="text-center mb-14">
          ...
          <h1 className="font-heading text-4xl md:text-[2.75rem] font-medium text-secondary mb-4 leading-tight">
      ...
      <section className="pb-16 px-4 md:px-8">
        <div className="contact-form-section max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[1.3fr_1.5fr] gap-6 items-stretch">
          ...
          <div className="order-2 lg:order-1 bg-[#080d17] rounded-3xl p-8 md:p-10 shadow-2xl flex flex-col w-full text-left relative overflow-hidden">
            ...
            <h2 className="font-heading text-[1.75rem] text-cream mb-4 relative z-10">Connect Directly</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      <option value="" disabled className="text-secondary/40">Choose a service</option>
                      {services.map((s) => (
