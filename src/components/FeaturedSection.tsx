...
import husbandWifeImg from "@/assets/service-love.webp";
import vashikaranImg from "@/assets/extra-marital.webp";
import fightimg from "@/assets/husband-wife-problem.webp";

gsap.registerPlugin(ScrollTrigger);

const featured = [
  { title: "Love Problem Solution in Chandigarh", img: loveProblemImg },
  { title: "Love Marriage Specialist in Chandigarh", img: loveMarriageImg },
  { title: "Marriage Problem Solution in Chandigarh", img: husbandWifeImg },
  { title: "Husband Wife Problem Solution in Chandigarh", img: fightimg },
  { title: "Family Problem Solution in Chandigarh", img: familyImg },
  { title: "Extra Marital Affair Solution in Chandigarh", img: vashikaranImg },
];
