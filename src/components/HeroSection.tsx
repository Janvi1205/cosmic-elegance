...
const HeroSection = () => {
  ...
  return (
    <section id="home" ref={sectionRef} className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-[1600px] mx-auto w-full px-6 md:px-12 lg:px-20 py-32 md:py-40">
        <div className="max-w-2xl flex flex-col items-center text-center md:items-start md:text-left xl:-ml-8">
          <div
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mb-12">
            ...
            <a
              ...
              className="hero-btn border border-cream/25 text-cream font-body font-semibold px-8 py-4 rounded-full inline-flex items-center justify-center gap-2.5 hover:bg-cream/10 transition-colors backdrop-blur-sm w-full sm:w-auto mt-2 sm:mt-0 opacity-0"
            >
